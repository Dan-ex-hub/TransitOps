...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TransitOps — Logistics Command" },
      { name: "description", content: "Fleet, dispatch and fuel intelligence for modern logistics operators." },
      { property: "og:title", content: "TransitOps — Logistics Command" },
      { property: "og:description", content: "Fleet, dispatch and fuel intelligence in one command surface." },
